...
(* OASIS_START *)
(* DO NOT EDIT (digest: abcd311e72d5b7b1bc056a675a9c6fd1) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "type-conv support";
                      flag_default = [(OASISExpr.EBool true, true)];
                      });
               Library
                 ({
                     cs_name = "pa_deriving_common";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      },
                   {
                      ...
                      lib_findlib_parent = Some "deriving";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "pa_deriving_common"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Pa_deriving"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "pa_deriving_common";
                      lib_findlib_name = Some "std";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     cs_name = "pa_deriving_tc";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      lib_modules = ["Pa_deriving_tc"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "pa_deriving_common";
                      lib_findlib_name = Some "tc";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     cs_name = "pa_deriving_classes";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "pa_deriving_common";
                      lib_findlib_name = Some "classes";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     cs_name = "deriving-num";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "pa_deriving";
                           InternalLibrary "pa_deriving_classes"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules =
                        ["Deriving_interned"; "Deriving_dynmap"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "deriving";
                      lib_findlib_containers = [];
                      });
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "tests";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "deriving"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "notc.ml"; });
               Executable
                 ({
                     cs_name = "test_tc";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "tc.ml"; })
            ];
          plugins =
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "K\197\022l\137\226L\216\242\181\209\016\217\200P\197";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
