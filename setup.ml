...
(* OASIS_START *)
(* DO NOT EDIT (digest: 23b4c8ff9671743bccf84a6169e79210) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          files_ab = ["syntax/common/id.ml.ab"];
          sections =
            [
               Flag
                 ({
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = Some "pa_deriving";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\006\006å¦\1496\000,\003ý\141Ïÿ¢Lw";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
